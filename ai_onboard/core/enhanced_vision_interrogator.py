...
class EnhancedVisionInterrogator:
    ...
    def detect_project_type(self, responses: Dict[str, Any]) -> ProjectType:
        ...
        type_indicators = {
            ProjectType.WEB_APPLICATION: [
                "website", "web app", "frontend", "backend", "user interface",
            ...
            ProjectType.DATA_SCIENCE: [
                ...
                "dataset", "analytics", "statistics", "prediction"
            ],
            ProjectType.API_SERVICE: [
                "api", "service", "microservice", "endpoint", "rest",
                "graphql", "integration", "backend service"
            ],
            ProjectType.AI_ML_PROJECT: [
                "artificial intelligence", "machine learning", "neural network",
                "deep learning", "nlp", "computer vision", "ai model"
            ]
        }
    ...
    def start_enhanced_interrogation(self, project_type: Optional[ProjectType] = None) -> Dict[str, Any]:
    ...
    def submit_enhanced_response(self, phase: str, question_id: str, response: Dict[str, Any]) -> Dict[str, Any]:
        ...
        # Enhanced analysis
        insights = self._generate_enhanced_insights(phase, question_id, response, interrogation_data)
        ambiguities = self._identify_enhanced_ambiguities(phase, question_id, response, interrogation_data)
        ...
        follow_up_questions = self._generate_follow_up_questions(phase, question_id, response, interrogation_data)
        if follow_up_questions:
            interrogation_data["adaptive_questions"].extend(follow_up_questions)
        
        # Update vision quality score
        interrogation_data["vision_quality_score"] = self._calculate_enhanced_vision_quality(interrogation_data)
        ...
        return {
            ...
            "phase_complete": self._is_enhanced_phase_complete(interrogation_data, phase),
        ...
        return {
            "vision_core": [
                ...
                Question(
                    ...
                    validation_rules={"options": ["consumers", "businesses", "developers", "internal users", "other"]},
                ...
                Question(
                    ...
                    question_type=QuestionType.MULTIPLE_CHOICE,
                    validation_rules={"options": ["desktop", "mobile", "tablet", "all devices"]},
        ...
        return {
            "vision_core": [
                Question(
                    ...
                    insight_triggers=["mobile", "on-the-go", "location", "camera", "sensors"]
                ),
                Question(
                    id="ma_vc_02",
                    text="Which mobile platforms do you need to support?",
                    question_type=QuestionType.MULTIPLE_CHOICE,
                    validation_rules={"options": ["iOS", "Android", "Both", "Progressive Web App"]},
        ...
        return {
            "vision_core": [
                Question(
                    ...
                    insight_triggers=["data", "analysis", "insights", "patterns", "predictions"]
                ),
                Question(
                    id="ds_vc_02",
                    text="What type of analysis are you planning?",
                    question_type=QuestionType.MULTIPLE_CHOICE,
                    validation_rules={"options": ["descriptive", "predictive", "prescriptive", "exploratory"]},
        ...
        return {
            "vision_core": [
                Question(
                    ...
                    insight_triggers=["service", "endpoint", "integration", "data access"]
                ),
                Question(
                    id="api_vc_02",
                    ...
                    insight_triggers=["developers", "applications", "third-party", "internal"]
                )
            ]
        }
        ...
        return {
            "vision_core": [
                Question(
                    ...
                    question_type=QuestionType.OPEN_ENDED,
                    category="ai_problem",
                    insight_triggers=["machine learning", "artificial intelligence", "model", "prediction", "classification"]
                ),
                Question(
                    id="ai_vc_02",
                    text="What type of AI/ML approach are you considering?",
                    question_type=QuestionType.MULTIPLE_CHOICE,
                    validation_rules={"options": ["supervised learning", "unsupervised learning", "reinforcement learning", "deep learning", "NLP", "computer vision"]},
        ...
        return {
            "vision_core": [
                ...
                Question(
                    ...
                    insight_triggers=["users", "customers", "beneficiaries", "audience"]
                )
            ],
            "stakeholders": [
                Question(
                    ...
                    insight_triggers=["stakeholder", "decision maker", "influencer", "sponsor"]
                ),
                Question(
                    id="gen_sg_02",
            ...
            "scope": [
                ...
                Question(
                    ...
                    insight_triggers=["out of scope", "exclude", "not included", "future"]
                )
            ],
            "success": [
                Question(
                    ...
                    insight_triggers=["measure", "metric", "kpi", "success", "performance"]
                ),
                Question(
                    id="gen_su_02",
    ...
    def _enhanced_validate_response(self, phase: str, question_id: str, response: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if not response.get("answer"):
            ...
            suggestions.append("Please provide a detailed answer to help clarify your vision")
        
        # Confidence validation
        confidence = response.get("confidence", 0)
        if not isinstance(confidence, (int, float)) or confidence < 0 or confidence > 1:
            errors.append("Confidence must be a number between 0 and 1")
            suggestions.append("Rate your confidence from 0 (not sure) to 1 (very confident)")
        ...
        if len(answer.strip()) < 20:
            ...
            suggestions.append("Consider adding more detail to make your vision clearer")
        
        # Content quality suggestions
        if answer and len(answer.strip()) > 20:
            if not any(word in answer.lower() for word in ["problem", "solution", "goal", "outcome", "user", "need"]):
                suggestions.append("Consider mentioning the problem you're solving or the outcome you want")
    ...
    def _analyze_response_metadata(self, response: Dict[str, Any]) -> Dict[str, Any]:
        ...
        metadata = {
            ...
            "contains_technical_terms": any(term in answer for term in [
                "api", "database", "algorithm", "framework", "architecture", "deployment"
            ]),
            "contains_business_terms": any(term in answer for term in [
                "revenue", "customer", "market", "business", "roi", "profit"
            ]),
            "contains_user_terms": any(term in answer for term in [
                "user", "customer", "experience", "interface", "usability"
            ]),
    ...
    def _analyze_sentiment(self, text: str) -> Dict[str, Any]:
        ...
        positive_words = ["excited", "confident", "clear", "definite", "sure", "positive"]
        negative_words = ["uncertain", "confused", "unclear", "maybe", "possibly", "not sure"]
    ...
    def _generate_enhanced_insights(self, phase: str, question_id: str, response: Dict[str, Any], interrogation_data: Dict[str, Any]) -> List[Dict[str, Any]]:
    ...
    def _identify_enhanced_ambiguities(self, phase: str, question_id: str, response: Dict[str, Any], interrogation_data: Dict[str, Any]) -> List[Dict[str, Any]]:
    ...
    def _generate_follow_up_questions(self, phase: str, question_id: str, response: Dict[str, Any], interrogation_data: Dict[str, Any]) -> List[Dict[str, Any]]:
    ...
    def _calculate_enhanced_vision_quality(self, interrogation_data: Dict[str, Any]) -> float:
        ...
        if insights:
            quality_insights = len([i for i in insights if i.get("confidence", 0) > 0.7])
    ...
    def _is_enhanced_phase_complete(self, interrogation_data: Dict[str, Any], phase: str) -> bool:
        ...
        phase_ambiguities = [
            a for a in interrogation_data.get("ambiguities", [])
    ...
    def _complete_enhanced_phase(self, interrogation_data: Dict[str, Any], phase: str) -> None:
        ...
        if current_index + 1 < len(phases):
            ...
            interrogation_data["final_vision_quality"] = self._generate_vision_quality_report(interrogation_data)
            
            # Auto-sync to charter
            try:
                from .interrogation_to_charter import auto_sync_on_completion
                if auto_sync_on_completion(self.root):
                    print("[OK] Enhanced vision interrogation data synced to charter.json")
            except Exception as e:
                print(f"[WARNING] Error syncing to charter: {e}")
    
    def _generate_vision_quality_report(self, interrogation_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {
            ...
            "ambiguity_summary": {
                ...
                "unresolved": len([a for a in ambiguities if not a.get("resolved", False)])
            },
            "recommendations": self._generate_final_recommendations(insights, ambiguities)
        }
    
    def _generate_final_recommendations(self, insights: List[Dict[str, Any]], ambiguities: List[Dict[str, Any]]) -> List[str]:
        ...
        critical_ambiguities = [a for a in ambiguities if a.get("priority") == "critical"]
        if critical_ambiguities:
            recommendations.append("Address critical ambiguities before proceeding with development")
        
        high_ambiguities = [a for a in ambiguities if a.get("priority") == "high"]
        if len(high_ambiguities) > 3:
            recommendations.append("Consider additional stakeholder discussions to clarify high-priority ambiguities")
        
        return recommendations
    
    def _generate_recommendations(self, insights: List[Dict[str, Any]], ambiguities: List[Dict[str, Any]]) -> List[str]:
    ...
    def _get_phase_questions(self, phase: str, project_type: ProjectType) -> List[Question]:
        """Get questions for a specific phase and project type."""
        template = self.question_templates.get(project_type, self.question_templates[ProjectType.GENERIC])
    ...
    def get_enhanced_interrogation_status(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "adaptive_questions_count": len(interrogation_data.get("adaptive_questions", [])),
