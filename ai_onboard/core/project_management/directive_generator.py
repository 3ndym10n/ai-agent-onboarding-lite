...
from ..orchestration.comprehensive_tool_discovery import (
    get_comprehensive_tool_discovery,
)

# PatternRecognitionSystem import moved to function level
...
class DirectiveGenerator:
    ...
    def _get_system_state(self) -> Dict[str, Any]:
        ...
        try:
            ...
            from ..orchestration.automatic_error_prevention import (
