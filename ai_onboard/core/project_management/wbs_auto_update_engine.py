...
class WBSAutoUpdateEngine:
    ...
    def __init__(self, root: Path):
        ...
        self.completion_sources: List[Callable] = []

    def _apply_auto_updates(self) -> Dict[str, Any]:
        """Apply automatic updates to WBS."""
        return self.auto_update_wbs(force=True)
    ...
    def _check_code_quality_metrics(
        ...
        try:
            ...
            from ..continuous_improvement.continuous_improvement_system import (
                get_continuous_improvement_system,
            )

            ci_system = get_continuous_improvement_system(self.root)
            quality_data = ci_system.get_latest_quality_metrics()  # type: ignore[attr-defined]
    ...
    def _check_continuous_improvement(
        ...
        try:
            ...
            improvement_data = ci_system.get_recent_improvements(limit=10)  # type: ignore[attr-defined]
        ...
        try:
            ...
            if phase_id in wbs_data.get("work_breakdown_structure", {}):
                ...
                if "subtasks" in phase and task_id in phase["subtasks"]:
                    ...
                    sync_result = sync_engine.update_wbs_data(  # type: ignore[attr-defined]
    ...
    def _send_task_ready_notification(self, task_id: str) -> None:
        ...
        try:
            from ..ai_integration.user_experience_system import (
