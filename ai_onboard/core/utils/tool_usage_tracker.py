...
class ToolUsageTracker:
    ...
    def __init__(self, root):
        ...
        self.tools_log_path = self.root / ".ai_onboard" / "tool_usage.jsonl"
        self.session_tools_path = self.root / ".ai_onboard" / "session_tools.json"
...
def get_tool_tracker(root) -> ToolUsageTracker:
