...
import json
from . import utils, charter, planning
...
class VisionGuardian:
    ...
    def validate_decision_alignment(self, decision: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if milestone_impact["delays_milestones"]:
            warnings.append(f"Change may delay milestone: {milestone_impact['affected_milestones']}")
            alignment_score -= 0.1
    ...
    def update_vision_documents(self, updates: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if "vision" in updates:
            ...
            changes_made.append(f"Vision updated: '{old_vision}' -> '{updates['vision']}'")
        ...
        # Log vision update
        self._log_vision_event("vision_updated", {
    ...
    def _assess_milestone_impact(self, decision: Dict[str, Any], vision_context: Dict[str, Any]) -> Dict[str, Any]:
