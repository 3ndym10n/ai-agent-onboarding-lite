...
class AdaptiveConfigManager:
    ...
    def _initialize_default_rules(self) -> None:
        ...
        default_rules = [
            ...
            AdaptationRule(
                ...
                description="Enable autonomous mode for users with high confidence and \
                    low error rates",
                condition={
    ...
    def _log_configuration_change(self, change: ConfigurationChange) -> None:
    ...
    def _save_config_profiles(self) -> None:
