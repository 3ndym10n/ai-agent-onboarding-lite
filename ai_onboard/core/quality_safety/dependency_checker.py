...
from ..base.common_imports import Enum, Path, dataclass
from ..utilities.unicode_utils import print_content, print_status, safe_print


def _is_relative_to(child: Path, parent: Path) -> bool:
    """Check if child path is relative to parent path (Python 3.8 compatible)."""
    try:
    ...
    def _scan_python_file(
        ...
        target_patterns = [
            ...
            (
                ...
                if _is_relative_to(target_file, self.root)
                else None
            ),
            target_file.name,
