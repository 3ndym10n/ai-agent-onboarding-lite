...
def sync_interrogation_to_charter(root: Path) -> bool:
    ...
    try:
        ...
        charter = {
            ...
            "vision": vision_core.get('vc_02', {}).get('response', {}).get('answer', ''),
            "objectives": [
            ...
            "stakeholders": [
                {
                    ...
                    "role": "Decision Maker", 
                    "decider": True,
                    "goals": stakeholders.get('sg_02', {}).get('response', {}).get('answer', '')
                }
            ],
            "constraints": {
                "time": "Limited but can give time as needed",
                "budget": "Very low cost or free solutions only",
                "compliance": ["Must work within cursor-ai", "Python 3.8+ compatibility"]
            },
            "assumptions": [
            ...
            "success_metrics": [
                {
                    ...
                    "description": success.get('sc_01', {}).get('response', {}).get('answer', '')
                },
                {
                    "name": "Feature Utilization", 
                    "target": "All designed features used at least once",
                    "description": success.get('sc_02', {}).get('response', {}).get('answer', '')
                },
                {
                    "name": "System Compliance",
                    "target": "System utilizes all functions in projects",
                    "description": success.get('sc_03', {}).get('response', {}).get('answer', '')
                }
            ],
            "risk_appetite": "low",
