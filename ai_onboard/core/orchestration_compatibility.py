...
class ToolApplicationTrigger:
    ...
    def __init__(self, trigger_type: str, keywords: List[str] = None, 
                 contexts: List[str] = None, patterns: List[str] = None,
                 priority: int = 1, cooldown_minutes: int = 30):
...
class IntelligentToolOrchestrator:
    ...
    def analyze_conversation_for_tool_application(
        self, conversation_history: List[Dict[str, Any]], current_context: Dict[str, Any]
    ) -> List[Dict[str, Any]]:
    ...
    def execute_automatic_tool_application(
        ...
        result = self._unified_orchestrator._execute_tool_safely(tool_name, execution_context)
...
class HolisticToolOrchestrator:
    ...
    def orchestrate_tools_for_request(
        ...
        unified_strategy = strategy_mapping.get(strategy, UnifiedOrchestrationStrategy.ADAPTIVE)
        ...
        legacy_result.user_preference_compliance = unified_result.user_preference_compliance
...
class ConversationContext:
    ...
    def __init__(self, session_id: str, user_id: str, project_root: Path):
