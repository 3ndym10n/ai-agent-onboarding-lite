...
class AIAgentGateDetector:
    ...
    def create_response_file(self, user_responses: list, user_decision: str, additional_context: str = ""):
...
def create_gate_response(user_responses: list, user_decision: str, additional_context: str = "", project_root: Path = None):
