...
from . import utils
from .enhanced_vision_interrogator import get_enhanced_vision_interrogator, ProjectType
from .gate_system import GateType, GateRequest
...
class AIAgentCollaborationProtocol:
    ...
    def register_agent(self, agent_profile: AgentProfile) -> Dict[str, Any]:
        ...
        try:
            ...
            if agent_profile.collaboration_mode.value in self.protocol_config.get("blocked_collaboration_modes", []):
                return {
                    "status": "error",
    ...
    def start_collaboration_session(self, agent_id: str, project_root: Optional[Path] = None) -> Dict[str, Any]:
    ...
    def execute_agent_action(self, session_id: str, action: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            if not safety_result["safe"]:
                ...
                return {
                    ...
                    "severity": safety_result["severity"],
                    "requires_user_approval": safety_result.get("requires_user_approval", False)
                }
            ...
            if len(session.actions_taken) >= session.agent_profile.max_autonomous_actions:
    ...
    def handle_user_interaction(self, session_id: str, interaction: Dict[str, Any]) -> Dict[str, Any]:
    ...
    def get_session_status(self, session_id: str) -> Dict[str, Any]:
        ...
        return {
            ...
            "agent_profile": {
                ...
                "capabilities": [cap.value for cap in session.agent_profile.capabilities],
            ...
            "context": session.context,
            "recent_actions": session.actions_taken[-5:] if session.actions_taken else [],
            "recent_violations": session.safety_violations[-3:] if session.safety_violations else []
        }
    
    def end_collaboration_session(self, session_id: str, reason: str = "completed") -> Dict[str, Any]:
    ...
    def _validate_agent_profile(self, profile: AgentProfile) -> Dict[str, Any]:
        ...
        if profile.collaboration_mode.value not in valid_modes:
            errors.append(f"Invalid collaboration mode: {profile.collaboration_mode.value}")
    ...
    def _initialize_session_context(self, session: CollaborationSession) -> Dict[str, Any]:
        """Initialize context for a collaboration session."""
        context = {
            "project_root": str(session.project_root),
            "agent_capabilities": [cap.value for cap in session.agent_profile.capabilities],
            "collaboration_mode": session.agent_profile.collaboration_mode.value,
            "safety_level": session.agent_profile.safety_level.value,
        ...
        try:
            ...
            if charter_path.exists():
                ...
                context["vision_confirmed"] = charter_data.get("vision_confirmed", False)
    ...
    def _perform_safety_checks(self, session: CollaborationSession, action: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if session.agent_profile.blocked_commands and action_type in session.agent_profile.blocked_commands:
            return {
                "safe": False,
    ...
    def _execute_vision_interrogation_action(self, session: CollaborationSession, action: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if action_subtype == "start_interrogation":
            ...
            try:
                ...
                result = self.vision_interrogator.start_enhanced_interrogation(project_type_enum)
                return {
                    "status": "success",
    ...
    def _execute_project_analysis_action(self, session: CollaborationSession, action: Dict[str, Any]) -> Dict[str, Any]:
    ...
    def _execute_planning_action(self, session: CollaborationSession, action: Dict[str, Any]) -> Dict[str, Any]:
    ...
    def _execute_gate_interaction_action(self, session: CollaborationSession, action: Dict[str, Any]) -> Dict[str, Any]:
    ...
    def _execute_file_operation_action(self, session: CollaborationSession, action: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if operation == "read":
            try:
                file_content = (session.project_root / file_path).read_text(encoding='utf-8')
                return {
                    "status": "success",
                    "action": "file_read",
    ...
    def _execute_command_action(self, session: CollaborationSession, action: Dict[str, Any]) -> Dict[str, Any]:
    ...
    def _handle_approval_interaction(self, session: CollaborationSession, interaction: Dict[str, Any]) -> Dict[str, Any]:
    ...
    def _handle_rejection_interaction(self, session: CollaborationSession, interaction: Dict[str, Any]) -> Dict[str, Any]:
    ...
    def _handle_clarification_interaction(self, session: CollaborationSession, interaction: Dict[str, Any]) -> Dict[str, Any]:
    ...
    def _handle_guidance_interaction(self, session: CollaborationSession, interaction: Dict[str, Any]) -> Dict[str, Any]:
    ...
    def _generate_session_summary(self, session: CollaborationSession, reason: str) -> Dict[str, Any]:
        ...
        return {
            ...
            "user_interactions": len(session.user_interactions),
            "end_reason": reason,
            "capabilities_used": [cap.value for cap in session.agent_profile.capabilities]
        }
