...
def _prepare_text_for_output(
    text: str, encoding: str, *, force_ascii: bool = False
) -> str:
    ...
    try:
        return normalized_text.encode(target_encoding, errors="replace").decode(
...
def format_with_fallback(
    text: str, unicode_chars: Optional[Dict[str, str]] = None
) -> str:
    """
...
def create_separator(char: str = "─", width: Optional[int] = None) -> str:
    """
...
def print_separator(
    char: str = "─", width: Optional[int] = None, **kwargs: Any
) -> None:
    """
...
def print_box(content: str, title: Optional[str] = None, **kwargs: Any) -> None:
    """
