...
class SessionStorageManager:
    ...
    def create_session_context(
        ...
        *,
        ...
        from ..orchestration.orchestration_compatibility import (
            ConversationContext,
            ConversationState,
            DecisionStage,
        )
        ...
        context = ConversationContext(
            ...
            state=state or ConversationState.ACTIVE,  # type: ignore[arg-type]
            ...
            current_stage=current_stage or DecisionStage.ANALYSIS,  # type: ignore[arg-type]
