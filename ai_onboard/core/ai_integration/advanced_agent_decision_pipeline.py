...
from ..orchestration.orchestration_compatibility import ConversationContext
...
class AdvancedDecisionPipeline:
    ...
    def _enhance_decision_context(self, context: DecisionContext) -> Dict[str, Any]:
        ...
        try:
            ...
            enhancement_result["project_context_error"] = str(e)  # type: ignore[assignment]
    ...
    def _moderate_decision_strategy(
        ...
        if confidence >= threshold:
            return {
                ...
                "reasoning": (
                    f"Moderate decision with sufficient confidence ({confidence:.2f}). "
    ...
    def _critical_decision_strategy(
        ...
        if confidence >= threshold:
            ...
            return {
                "outcome": DecisionOutcome.ESCALATE,
                "reasoning": (
                    f"Critical decision with insufficient confidence ({confidence:.2f}) "
