...
class AIAgentGuidanceSystem:
    ...
    def _initialize_guidance_items(self) -> None:
...
```
    ...
    def _add_guidance_item(self, item: GuidanceItem) -> None:
    ...
    def _check_agent_level_up(self, agent_profile: AgentGuidanceProfile) -> None:
