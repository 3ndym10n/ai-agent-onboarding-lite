...
class VisionInterrogator:
    ...
    def check_vision_readiness(self) -> Dict[str, Any]:
        ...
        vision_clarity = self._calculate_vision_clarity(
            charter_data, interrogation_data
        )

        # Determine readiness
        ready_for_agents = interrogation_complete and vision_clarity["score"] >= 0.8
    ...
    def _calculate_vision_clarity(
        self, charter_data: Dict[str, Any], interrogation_data: Dict[str, Any]
    ) -> Dict[str, Any]:
    ...
    def _is_phase_complete(
        ...
        answered_required = sum(
            1 for q in required_questions if q["id"] in phase_responses
        )
    ...
    def get_current_questions(self) -> Dict[str, Any]:
        ...
        if current_phase in interrogation_data.get("responses", {}):
            answered_questions = set(
                interrogation_data["responses"][current_phase].keys()
            )
    ...
    def get_interrogation_summary(self) -> Dict[str, Any]:
        ...
        total_questions = sum(
            len(self._get_phase_questions(phase))
