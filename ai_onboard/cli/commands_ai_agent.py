...
def add_ai_agent_commands(subparsers):
    ...
    s_ai.add_argument("--conversation", action="store_true", help="Start interactive conversation mode")
    s_ai.add_argument("--preview", action="store_true", help="Show alignment preview without conversation")
    s_ai.add_argument("--test-guardrails", action="store_true", help="Test guardrail functionality")
