...
class ProjectAnalysisRequest(BaseModel):
    ...
    target_path: Optional[str] = Field(default=None, description="Specific path to analyze")
...
class PlanRequest(BaseModel):
    ...
    charter_id: Optional[str] = Field(default=None, description="Charter to base plan on")
...
class ValidationRequest(BaseModel):
    ...
    components: Optional[List[str]] = Field(default=None, description="Specific components to validate")
...
class AgentRegistrationRequest(BaseModel):
    ...
    requires_confirmation_for: List[str] = Field(default=[], description="Actions requiring confirmation")
