...
class TestContinuousImprovementValidatorIntegration:
    ...
    def test_validator_with_real_project_structure(self, real_validator, temp_project_root):
...
version = "0.1.0"
    ...
    def test_comprehensive_validation_execution(self, real_validator):
        ...
        try:
            ...
            assert execution_time < 120.0, f"Validation took too long: {execution_time}s"
    ...
    def test_validation_performance_characteristics(self, real_validator):
        ...
        if execution_times:
            ...
            assert avg_execution_time < 30.0, f"Average execution time too high: {avg_execution_time}s"
            assert max_memory_increase < 50.0, f"Memory usage too high: {max_memory_increase}MB"
    ...
    def test_error_handling_in_real_scenarios(self, real_validator):
        ...
        try:
            ...
            missing_component_tests = [t for t in tests if "not available" in t.error_message or ""]
    ...
    def test_configuration_validation_integration(self, real_validator, temp_project_root):
        ...
        assert custom_validator.test_config["performance_thresholds"]["response_time_ms"] == 300
...
class TestValidationSystemIntegration:
    ...
    def test_integration_with_user_preferences(self, temp_project_root):
        ...
        try:
            from ai_onboard.core.user_preference_learning import get_user_preference_learning_system
