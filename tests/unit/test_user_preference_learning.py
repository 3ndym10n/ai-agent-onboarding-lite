...
def preference_system(temp_root):
    ...
    with patch('ai_onboard.core.user_preference_learning.telemetry'), \
         patch('ai_onboard.core.user_preference_learning.get_unified_metrics_collector'):
...
class TestUserPreferenceLearningSystem:
    ...
    def test_initialization(self, temp_root):
        ...
        with patch('ai_onboard.core.user_preference_learning.telemetry'), \
            ...
            assert system.preferences_path == temp_root / ".ai_onboard" / "user_preferences"
            assert system.learning_data_path == temp_root / ".ai_onboard" / "learning_data"
    ...
    def test_record_user_interaction(self, preference_system, sample_user_interactions):
        ...
        preference_system.record_user_interaction(
            ...
            outcome={"success": interaction["success"], "duration": interaction["duration"]}
        )
    ...
    def test_learn_preferences_from_interactions(self, preference_system, sample_user_interactions):
        ...
        # Learn preferences
        learned_preferences = preference_system.learn_preferences_from_interactions(user_id)
    ...
    def test_update_preference_confidence(self, preference_system):
        ...
        updated_pref = next(p for p in updated_prefs if p.preference_key == preference_key)
    ...
    def test_adaptive_learning(self, preference_system, sample_user_interactions):
        ...
        for i, interaction in enumerate(sample_user_interactions):
            ...
            interaction_time = datetime.now() - timedelta(days=len(sample_user_interactions) - i)
    ...
    def test_confidence_levels(self, preference_system, confidence_level):
        ...
        retrieved_prefs = preference_system.get_user_preferences(user_id)
        matching_pref = next(p for p in retrieved_prefs 
    ...
    def test_end_to_end_learning_cycle(self, temp_root):
        ...
        with patch('ai_onboard.core.user_preference_learning.telemetry'), \
            ...
            interactions = [
                ...
                {"action": "preference_selection", "preference": "verbose_output", "value": True},
                {"action": "command_execution", "command": "validate", "success": True},
                {"action": "preference_selection", "preference": "auto_fix", "value": False},
                {"action": "error_handling", "error_type": "validation", "resolution": "manual_fix"}
            ]
