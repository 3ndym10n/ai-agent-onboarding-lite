...
class TestCleanupSafetyGatesIntegration(unittest.TestCase):
    ...
    def test_protected_file_deletion_blocked_by_preflight(self):
        ...
        self.assertTrue(self.protected_file.exists(), "Protected file should still exist")
    ...
    def test_file_with_dependencies_requires_confirmation(self):
        ...
        self.assertFalse(success, "File with dependencies should fail without proper confirmation")
        self.assertTrue(self.test_file.exists(), "File should still exist after denied confirmation")
    ...
    def test_risk_assessment_escalation(self):
        ...
        self.assertIn(context.risk_assessment.level, [RiskLevel.MEDIUM, RiskLevel.HIGH, RiskLevel.CRITICAL])
    ...
    def test_backup_and_rollback_functionality(self):
        ...
        self.assertEqual(test_file.read_text(), original_content, "Content should be restored")
    ...
    def test_post_operation_validation_with_failure(self):
        ...
        with patch.object(PostOperationGate, 'validate') as mock_validate:
            mock_validate.return_value = (GateResult.FAIL, "Post-validation failed - test scenario")
        ...
        self.assertFalse(success, "Operation should fail due to post-validation failure")
    ...
    def test_emergency_rollback_on_exception(self):
        ...
        with patch.object(BackupExecuteGate, '_execute_operation', side_effect=Exception("Test exception")):
            with patch('builtins.input', return_value='CONFIRM'):
                success, message = self.framework.execute_cleanup_operation(operation)
        ...
        self.assertTrue(test_file.exists(), "File should be restored after exception rollback")
    ...
    def test_configuration_affects_gate_behavior(self):
        ...
        self.assertFalse(success, "Strict mode should require confirmation for medium risk")
    ...
    def test_multiple_file_operations_with_mixed_risks(self):
        ...
        self.assertFalse(success, "Mixed risk operation should be blocked by highest risk")
        self.assertTrue(safe_file.exists(), "Safe file should remain due to batch failure")
        self.assertTrue(risky_file.exists(), "Risky file should remain due to dependencies")
    ...
    def test_convenience_function_integration(self):
        ...
        self.assertFalse(safe_file.exists(), "File should be deleted via convenience function")
