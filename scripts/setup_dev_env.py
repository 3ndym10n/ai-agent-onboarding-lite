...
"""
    ...
    def create_ide_configs(self) -> bool:
        ...
        try:
            ...
            vscode_settings = {
                "python.defaultInterpreterPath": "./venv/Scripts/python.exe" if self.is_windows else "./venv/bin/python",
            ...
            if not idea_dir.exists():
                ...
                (idea_dir / "misc.xml").write_text("""<?xml version="1.0" encoding="UTF-8"?>
<project version="4">
